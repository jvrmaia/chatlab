...
OS-keychain integration (macOS Keychain, Linux Secret Service, Windows Credential Manager) is a future enhancement; v0.1.0 sticks to file + env to avoid native deps.
