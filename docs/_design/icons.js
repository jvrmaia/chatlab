/* ChatLab — Lucide-style stroke icons */
window.Icon = function Icon({ name, size = 16, stroke = 1.6, style = {}, className = '' }) {
  ...
  }, p.split('|').map((d, i) => React.createElement('path', { key: i, d })));
};
...
window.ICON_PATHS = {
  ...
  bot: 'M12 8V4|M5 8h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2z|M9 13v2|M15 13v2|M2 14h2|M20 14h2',
  ...
  panel: 'M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5z|M15 3v18',
  ...
  beaker: 'M9 3h6v5l5 9a2 2 0 0 1-1.74 3H5.74A2 2 0 0 1 4 17l5-9V3z|M7 14h10',
  flask: 'M9 2v6L4 18a2 2 0 0 0 1.74 3h12.52A2 2 0 0 0 20 18L15 8V2|M9 2h6|M7 14h10',
  workspace: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z|M9 22V12h6v10',
  thumbsUp: 'M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3z|M7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3',
  thumbsDown: 'M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3z|M17 2h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17',
