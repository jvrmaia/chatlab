...
- **Cross-workspace queries / data joins** — every workspace is an island in v0.1.0.
...
- **Backup / snapshot** — out of scope for v0.1.0; users manage their own `~/.chatlab/data/` files.
