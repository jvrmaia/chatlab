...
2. Should there be a "flag for review" affordance in the UI that sets `flagged_for_review: true`? The export field exists but the UI doesn't surface it in v0.1.0.
