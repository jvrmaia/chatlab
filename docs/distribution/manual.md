...
> **Status:** Available today (**v0.1.0**). This is the recommended path for contributors and source-first users.
...
| `npm test` | Run the Vitest suite (113 tests, ~2s) |
...
```bash
# Terminal 1: chatlab backend on 4480
npm run dev
...
- Add real Playwright E2E test scenarios beyond the screenshot-capture spec — `docs/_capture/` already wires Playwright; v0.2.0 expands it into the deferred E2E tier per [ADR 0010](../specs/adr/0010-test-strategy.md).
- Pick up any v0.2.0 item from [`ROADMAP.md`](../ROADMAP.md) — multimodal forwarding, streaming responses, tool calling, workspace duplicate, etc.
