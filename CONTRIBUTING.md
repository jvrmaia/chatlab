...
Thanks for your interest in contributing! As of **v0.1.0** chatlab runs end-to-end and capabilities `0001`–`0006` are implemented. Both spec/docs work and code contributions are welcome.
...
We follow [SemVer](https://semver.org/). v0.1.0 is the first public release; **breaking changes require a minor bump** until v1.0.0. Pre-release versions use the `-rc.N` suffix (`0.1.0-rc.1`, `0.1.0-rc.2`, …) until the maintainer drops the suffix at tag time.
