...
- Não dispara webhooks (sem superfície built-in de webhook — veja o [Roadmap](https://github.com/jvrmaia/chatlab/blob/main/docs/ROADMAP.md))
...
A v0.1.0 é a primeira release sob o nome `chatlab`. Releases tagueadas publicam no npm sob a dist-tag `latest` (estável) ou `next` (pré-release).
